...
function insertTalk(){
  ...
  if(USER_NUM =='' || USER_NUM == null){
	...
	location.href='/board/proof_shot_insert';
}

// $(document).on('mouseenter','.list_item4',function(){
// 	$(this).css('transform','scale(1.03)');
// 	$(this).css('transition','.3s');
// });

// $(document).on('mouseleave','.list_item4',function(){
// 	$(this).css('transform','scale(1)');
// 	$(this).css('transition','.3s');	
// });
</script>
<style type="text/css">
.study_box .list_item4 .item_content_box .item_txt > p > span{
    font-family: "Pretendard" !important;	
	font-size : 14px !important;
	color : var(--Gray-50) !important;
	font-weight: 400 !important;
}
.study_box .list_item4 .item_content_box .item_txt > p > img{
    ...
    <div class="board_btn_box search">
      ...
      <div class="filter_container">
      	<div class="inner_container">
      		<c:if test="${m ne null}">
 	        <button class="gray_square_btn my" id="my_item">내 인증샷</button>      
