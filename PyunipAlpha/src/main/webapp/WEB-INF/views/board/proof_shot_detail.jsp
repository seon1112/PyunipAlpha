...
function updateProf(nSelect){
	...
	location.href='/board/proof_shot_update_form?BRD_NUM='+BRD_NUM+'&nSelect='+nSelect;
}
...
function deleteBoard(){
	...
	$.ajax({
		...
		success:function(msg){
			if(msg == ""){
				location.href='/board/proof_shot_form';
			}else{
				alert(msg);				
			}
		},
...
<div class="content">
	...
	<div class="board_info">
      <div class="talk_header bottom">
        <div class="talk_writer">${t.USER_NM }</div>
        <div class="header_btn">
          <c:if test="${t.REG_USER_NUM eq USER_NUM }">
          <a class="org_btn" href="javascript:updateProf('${nSelect}')">수정</a>
      ...
      <div class="item_info_box">
        <div class="item_info_wrap">
          ...
          <div class="item_info" id="like_size">
           ...
           <div class="reg_date"><c:out value="${t.REG_DTM}"></c:out></div>
      </div>
    </div>
    <!-- 게시글 내용 -->
    <div class="board_content">
	  <c:choose>
	   <c:when test="${t.FILE_YN eq 'Y'}">
	     <div class="item_image" style="background-image: url('/upload/image/proof/${t.FILE_NAME }');" style="height : 100%;"></div>
	   </c:when>
	   <c:otherwise>
...
<input type="hidden" id="BRD_CTG" value="5">
<!--하단 footer -->
