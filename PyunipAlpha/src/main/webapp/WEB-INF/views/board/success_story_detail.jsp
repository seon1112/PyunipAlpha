...
function updateSuc(nSelect){
	...
	location.href='/board/success_story_update_form?BRD_NUM='+BRD_NUM+'&nSelect='+nSelect;
}
	...
	<c:choose>
	   <c:when test="${error eq null }">
	    <div class="board_info">
	      <div class="talk_header bottom success">
	        <div class="header_title">${t.SUC_UNIV}  ${t.SUC_YY}년 합격수기</div>
	        <div class="header_btn">
	          <c:if test="${t.REG_USER_NUM eq USER_NUM }">
	          <a class="org_btn" href="javascript:updateSuc('${nSelect}')">수정</a>
	          <button type="button" class="darkGray_btn" onclick="deleteBoard()">삭제</button>
	          </c:if>
	          <a class="gray_btn" href="javascript:goList('${nSelect}')">목록</a>
	        </div>
	      </div>
	      <div class="board_title small_font"><c:out value="${t.TITLE}"></c:out></div>
