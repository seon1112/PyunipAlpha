  ...
  <div class="ad_content_box">
	...
	<div class="content">
	  ...
	  <div class="content_box"  id="content_info">
		  ...
		  <!-- 목록버튼 -->  
		  <div class="btn_box">
	        <a class="base_btn" href="/admin/board/proof_shot_update?BRD_NUM=${t.BRD_NUM}">수정</a>      
	        <button type="button" class="base_btn" onclick="deleteBoard()">삭제</button>      
		    <a class="gray_btn"  href="/admin/board/ad_proof_shot">목록</a>  
		  </div>	  
      </div>
	 <!--  -->
