	  ...
	  <div class="content_box"  id="content_info">
	      ...
	      <div class="write_box">
	           <div class="write border">
	             ...
	             <div class="input_box">${t.SUC_YY}년</div>
	           </div>		      
	           <div class="write border">
	             <div class="title">편입대학교</div>
	             <div class="input_box">${t.SUC_UNIV }</div>
	           </div>		      
	           <div class="write border">
		  ...
		  <!-- 목록버튼 -->  
		  <div class="btn_box">
	        <a class="base_btn" href="/admin/board/success_story_update?BRD_NUM=${t.BRD_NUM}">수정</a>      
	        <button type="button" class="base_btn" onclick="deleteBoard()">삭제</button>      
		    <a class="gray_btn"  href="/admin/board/ad_success_story">목록</a>  
		  </div>	  
      </div>
	<!--  -->
