...
function deleteBoard(){
  ...
  $.ajax({
    ...
    success:function(msg){
      if(msg == ""){
        location.href='/admin/board/ad_study';
      }else{
        alert(msg);       
      }
    },
	  ...
	  <div class="content_box"  id="content_info">
	      ...
	      <div class="write_box">
	           ...
	           <div class="write border">
	             ...
	             <div class="input_box">${t.APPLY_ED_DTM }</div>
	           </div>		      
	           <div class="write border">
	             <div class="title">모집인원</div>
	             <div class="input_box">${t.APY_SIZE }명</div>
	           </div>		      
	           <div class="write border">
	             <div class="title">진행방법</div>
	             <div class="input_box">${t.PCD_WAY_ST}</div>
	           </div>		      
	           <div class="write border">
	             <div class="title">진행기간</div>
	             <div class="input_box">${t.ST_DTM} ~ ${t.ED_DTM}</div>
	           </div>		      
	           <div class="write border">
		  ...
		  <!-- 목록버튼 -->  
		  <div class="btn_box">
	        <a class="base_btn" href="/admin/board/study_update?BRD_NUM=${t.BRD_NUM}">수정</a>      
	        <button type="button" class="base_btn" onclick="deleteBoard()">삭제</button>      
		    <a class="gray_btn"  href="/admin/board/ad_study">목록</a>  
		  </div>	  
      </div>
	<!--  -->
